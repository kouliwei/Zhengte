/**
  ...
  *          available on DevKit1207 evaluation board.  
  ******************************************************************************
  * @attention
  *
...
--------------------------
   - This driver supports STM32F2xx devices on DevKit1207 Evaluation boards.
...
static uint32_t Codec_Init(uint16_t OutputDevice, uint8_t Volume, uint32_t AudioFreq)
{
  ...
  /*modify by lichy 11/11/26 
	 This function has Repeated initialization I2C Control.
	 That Case the I2C Busy Error
   */  
